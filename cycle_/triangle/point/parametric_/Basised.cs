...
using mou=nilnul.num.real.matrix_.square_.invertible.op_.unary_;


namespace nilnul.geometry.planar.cycle_.triangle.point.parametric_
{
	/// <summary>
