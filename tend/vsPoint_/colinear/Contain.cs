...
namespace nilnul.geometry.planar.tend.vsPoint_.coline
{
	static public class _ContainX
	{
		// Given three colinear points p, q, r, the function checks if
		// point q lies on line segment 'pr'
		static public bool? _Contain_ofColinear(Point1 begin, Point1 end, Point1 _point_colinear)
		{

			return planar.tend_.originated.vsPoint_.coline._ContainX.Contain(
				end-begin,
		...
		public static bool? _Contain_ofColinear(point.Co x, Point1 point)
		{
			return _Contain_ofColinear(x.begin,x.end,point);
			//throw new NotImplementedException();
		}
		public static bool? _Contain_ofColinear(IArrow y, Point1 end)
		{
			return _Contain_ofColinear(y.points,end);
			throw new NotImplementedException();
		}

		public static bool? _Contain_ofColinear(tend_.EdgeI x, Point1 _point_colinear)
		{
