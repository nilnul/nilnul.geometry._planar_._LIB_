...
namespace nilnul.geometry.planar
{
	...
	///		we may establish a new coordinates of an origin different from old one. <see cref="trans_.affine_.ITranslateOnly"/>
	///		we may flip the coordinates. <see cref="trans_.rebase_.IScaleOnly"/>
	/// 
