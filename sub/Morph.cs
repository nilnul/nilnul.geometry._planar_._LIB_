...
namespace nilnul.geometry.planar.sub
{
	...
	///			eg: we might map a flat facet of a square in 3d onto the screen using <see cref="trans_.rebase_.IShearOnly"/>. This is still a 2d to 2d trans, as we only transform one facet, which is 2d, from a 3d model.
