...
{
	/// <summary>
	/// <see cref="curve_.algebraic_.quadratic_."/>
	/// </summary>
	static public class Extensions
	{
		...
		/// <summary>
		/// draw a quater of ellipse from one point to another. Note the direction of the curve must be on the outer side of the diagonal.
		/// </summary>
